...
SYSTEM_INSTRUCTIONS = "You are an asssistant that talks like a cowboy."
...
PHASES = {
    "phase0": {
        ...
        "fields": {
            "welcome": {
                "type": "markdown",
                "body": "Howdy! This is a message with no input required. Let's move on....",
    ...
    "phase1": {
        ...
        "skip_run": True,
        "ai_response": "This is a hard coded Response, not generated by ai.",
        "allow_skip": True,
    },
    "phase2": {
        "name": "Introduction",
